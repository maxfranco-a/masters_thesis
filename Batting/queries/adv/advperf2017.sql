...
WHERE year =2017; ## 42 rows

CREATE TABLE perfadv2017 AS
SELECT 
    df5.*, 
    a.BABIP, 
    a.wOBA, 
...
SELECT * FROM thesisadvbat.perfadv2017
WHERE year =2017;
    
CREATE TABLE perfadv2017_2 AS
SELECT 
    p.*, 
    a.BABIP AS BABIP_2, 
    a.wOBA AS wOBA_2, 
...
DELETE FROM thesisadvbat.perfadv2017_2
WHERE year != 2017;

SELECT * FROM thesisadvbat.perfadv2017_2; ## 42 rows