...
WHERE year =2022; ## 57 rows

CREATE TABLE perfadv2022 AS
SELECT 
    df5.*, 
    a.BABIP, 
    a.wOBA, 
...
SELECT * FROM thesisadvbat.perfadv2022
WHERE year =2022;
    
CREATE TABLE perfadv2022_2 AS
SELECT 
    p.*, 
    a.BABIP AS BABIP_2, 
    a.wOBA AS wOBA_2, 
...
DELETE FROM thesisadvbat.perfadv2022_2
WHERE year != 2022;

SELECT * FROM thesisadvbat.perfadv2022_2; ## 57 rows