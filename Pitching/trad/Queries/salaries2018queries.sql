SELECT * FROM thesispitchv1.salaries2018;
...
#lowerletters
UPDATE salaries2018 SET Name = REPLACE(Name, 'á', 'a') WHERE Name LIKE '%á%';
UPDATE salaries2018 SET Name = REPLACE(Name, 'ó', 'o') WHERE Name LIKE '%ó%';
UPDATE salaries2018 SET Name = REPLACE(Name, 'é', 'e') WHERE Name LIKE '%é%';
UPDATE salaries2018 SET Name = REPLACE(Name, 'í', 'i') WHERE Name LIKE '%í%';
UPDATE salaries2018 SET Name = REPLACE(Name, 'ú', 'u') WHERE Name LIKE '%ú%';
...
##to keep pitchers
SELECT * FROM salaries2018;
DELETE FROM salaries2018
WHERE IP < AB;

#drop the IP and AB columns after 
ALTER TABLE salaries2018
DROP COLUMN IP,
DROP COLUMN AB;
SELECT * FROM salaries2018;
...
#change the ones with 2017, because all of them were after the 2017 season and it would corrupt the final database where we are adding the salaries2017
UPDATE salaries2018
SET Date = REPLACE(Date, '2017', '2018')
WHERE Date LIKE '%2017%';

#change the To Team columns to abbreviations
UPDATE salaries2018 s
